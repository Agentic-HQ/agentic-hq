...
```json
{
  "command-output-string": "(cd {skill-base-dir}/ts-workflow && pnpm install) && {skill-base-dir}/ts-workflow/node_modules/.bin/tsx --tsconfig {skill-base-dir}/ts-workflow/tsconfig.json {skill-base-dir}/ts-workflow/src/math-workflow-demo-cli.ts"
}
```
Tell the user:
