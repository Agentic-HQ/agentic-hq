---
description: Returns the command to run the birgitta-ousterhout-full-build TypeScript workflow
...
```json
{
  "command-output-string": "(cd {skill-base-dir}/ts-workflow && pnpm install && ln -sfn \"$AGENTIC_HQ_WORKSPACE_ROOT\" node_modules/agentic-hq) && {skill-base-dir}/ts-workflow/node_modules/.bin/tsx --tsconfig {skill-base-dir}/ts-workflow/tsconfig.json {skill-base-dir}/ts-workflow/src/birgitta-ousterhout-full-build-cli.ts"
}
```
