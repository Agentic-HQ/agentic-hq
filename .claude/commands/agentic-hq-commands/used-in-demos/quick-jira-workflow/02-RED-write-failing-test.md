...
`{project-root}/docs/jira-docs/{jira-id}/workflow-docs/01-entire-jira-copy-of-details.md`
...
Write the test file(s) relative to `{project-root}`.
...
Create the directory `{project-root}/docs/jira-docs/{jira-id}/workflow-docs/{test-type}-test-files` if it doesn't exist.

Write a summary of what test was written and why it fails to:
`{project-root}/docs/jira-docs/{jira-id}/workflow-docs/{test-type}-test-files/02-RED-write-failing-test.summary.md`
