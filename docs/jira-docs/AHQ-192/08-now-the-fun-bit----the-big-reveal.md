...
The workflow would be called the birgitta-ousterhout-full-build workflow because it would use John's design ideas and will have named "Guides" and "Sensors" proposed by Birgitta Böckeler from ThoughtWorks in https://martinfowler.com/articles/harness-engineering.html.  The Guides prompt Fable to do the right thing before doing it, the Sensors check that they have been done right and correct where they haven't.
